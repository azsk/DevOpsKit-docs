## [:exclamation:IMPORTANT: DevOps Kit (AzSK) is being sunset by end of FY21.](https://github.com/azsk/DevOpsKit-docs/blob/users/v-himkam/SunsetNotice/ReleaseNotes/AzSKSunsetNotice.md)
------------------------------------------------
