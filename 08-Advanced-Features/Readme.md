...
To enable this feature you must run below command. 	

```PowerShell
	Set-AzSKUserPreference -StoreComplianceSummaryInUserSubscriptions
```
You can disable this feature using 'DisableComplianceSummaryStorageInUserSubscriptions' switch param in same cmdlet above.
