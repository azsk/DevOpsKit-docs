...
* [Continuous Assurance:](https://azsk.azurewebsites.net/04-Continous-Assurance#setting-up-continuous-assurance---step-by-step)
	...
	* The parallel-CA scanning feature has been enhanced to [(a) support appending to existing target subscriptions and (b) central logging with subscription id as parent folder,](https://azsk.azurewebsites.net/04-Continous-Assurance#12-updatingmodifying-central-scan-mode-ca-single-automation-account-option) [(c) Get-CA has been made 'central-scan' mode aware (will emit central scanning setup info)](https://azsk.azurewebsites.net/04-Continous-Assurance#13-diagnosing-the-health-of-central-mode-ca-single-automation-account-option).
* OMS
...
* [ARM Template Checker (Preview)](https://azsk.azurewebsites.net/03-Security-In-CICD/Readme.md#azsk-arm-template-checker)
